...
import { AsyncLoadable, LoadingState, TextInputBase } from '@react-types/shared';
...
export type ComboboxProps<T> = TextInputBase & Omit<AriaComboBoxProps<T>, 'menuTrigger'> & FieldProps & BaseStyleProps & Omit<AsyncLoadable, 'isLoading'> & {
    /**
