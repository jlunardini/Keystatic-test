...
const headingClasses = new ClassList('Heading');
...
function useProseStyles(props) {
  ...
  return {
    ...
    className: classNames('ksv:Prose', css({
...
export { Emoji, Heading, Kbd, Numeral, Prose, Text, textClassList, useHeadingContext, useTextContext, useTextStyles };
