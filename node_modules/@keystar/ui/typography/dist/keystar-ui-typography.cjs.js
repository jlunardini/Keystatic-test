...
function useTextStyles(props) {
  ...
  return style.useStyleProps({
    ...otherProps,
    UNSAFE_className: [style.css(styles), UNSAFE_className, textClassList.root()]
  });
}
...
const headingClasses = new style.ClassList('Heading');
function useHeadingStyles({
  ...
  return style.useStyleProps({
    ...otherProps,
    UNSAFE_className: [style.css(styles), UNSAFE_className, headingClasses.root()]
  });
}
const sizeToWeight = {
...
function useProseStyles(props) {
  ...
  return {
    ...
    className: style.classNames('ksv:Prose', style.css({
