...
const useLinkComponent = ref => {
  ...
  assert(!ref || '__forwardRef__' in linkComponent, `You're passing a ref to a Keystar UI link, but your app is providing a custom link component to 'VoussoirProvider' that doesn't appear to support refs.
...
export { DefaultLinkComponent, LinkComponentContext, TextLink, makeLinkComponent, useLinkComponent };
