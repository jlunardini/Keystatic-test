...
import { useStyleProps, toDataAttributes, classNames, css, tokenSchema, FocusRing, transition } from '@keystar/ui/style';
...
function TabList(props) {
  ...
  const tabContent = /*#__PURE__*/jsxs("div", {
    ...
    }), 'ksv-tab-list', orientation === 'vertical' && styleProps.className),
  ...
  if (orientation === 'vertical') {
    ...
    return /*#__PURE__*/jsxs("div", {
      ...
      className: classNames(css({
        display: 'flex',
        position: 'relative'
      }), 'ksv-tabs-collapseWrapper', styleProps.className),
...
function TabPanel(props) {
  ...
  return /*#__PURE__*/jsx(FocusRing, {
    children: /*#__PURE__*/jsx("div", {
      ...
      }), 'ksv-tabs-panel', styleProps.className),
      children: props.children
    })
  });
}
...
export { TabList, TabPanels, _Tabs as Tabs };
