...
import { VoussoirProvider, useProvider } from '@keystar/ui/core';
import { ProgressCircle } from '@keystar/ui/progress';
import { toDataAttributes, classNames, css, tokenSchema, FocusRing, transition, useStyleProps } from '@keystar/ui/style';
...
function ListViewItem(props) {
  ...
  let chevron = /*#__PURE__*/jsx(Icon, {
    ...
    "aria-hidden": "true",
    UNSAFE_className: classNames('ksv-list-view-item-parent-indicator', css({
      display: 'none',
      gridArea: 'chevron',
  ...
  if (isDisabled) {
    content = /*#__PURE__*/jsx(VoussoirProvider, {
      isDisabled: true,
      children: content
    });
  }
  return /*#__PURE__*/jsx("div", {
    ...
    children: /*#__PURE__*/jsx("div", {
      ...
      className: classNames('ksv-list-view-item', css({
        display: 'grid',
        paddingInline: tokenSchema.size.space.medium,
        position: 'relative',
        outline: 0,
...
function ListView(props, ref) {
  ...
  const isListDraggable = !!(dragAndDropHooks !== null && dragAndDropHooks !== void 0 && dragAndDropHooks.useDraggableCollectionState);
  const isListDroppable = !!(dragAndDropHooks !== null && dragAndDropHooks !== void 0 && dragAndDropHooks.useDroppableCollectionState);
    ...
    children: [/*#__PURE__*/jsx(FocusScope, {
      children: /*#__PURE__*/jsx(FocusRing, {
        children: /*#__PURE__*/jsx(Virtualizer, {
          ...
          }), 'ksv-list-view', styleProps.className),
          layout: layout,
...
function CenteredWrapper({
  ...
  return /*#__PURE__*/jsx("div", {
    ...
    className: classNames('ksv-list-view-centered-wrapper', css({
      display: 'flex',
      justifyContent: 'center',
      alignItems: 'center',
      height: '100%',
