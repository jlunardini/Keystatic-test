...
function ListViewItem(props) {
  ...
  let chevron = /*#__PURE__*/jsxRuntime.jsx(icon.Icon, {
    ...
    "aria-hidden": "true",
    UNSAFE_className: style.classNames('ksv-list-view-item-parent-indicator', style.css({
      display: 'none',
      gridArea: 'chevron',
  ...
  if (isDisabled) {
    content = /*#__PURE__*/jsxRuntime.jsx(core.VoussoirProvider, {
      isDisabled: true,
      children: content
    });
  }
  return /*#__PURE__*/jsxRuntime.jsx("div", {
    ...
    children: /*#__PURE__*/jsxRuntime.jsx("div", {
      ...
      className: style.classNames('ksv-list-view-item', style.css({
        display: 'grid',
        paddingInline: style.tokenSchema.size.space.medium,
        position: 'relative',
        outline: 0,
...
function CenteredWrapper({
  ...
  return /*#__PURE__*/jsxRuntime.jsx("div", {
    ...
    className: style.classNames('ksv-list-view-centered-wrapper', style.css({
      display: 'flex',
      justifyContent: 'center',
      alignItems: 'center',
      height: '100%',
