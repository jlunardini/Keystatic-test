...
import { toDataAttributes, classNames, css, tokenSchema, useStyleProps, breakpointQueries, useMediaQuery } from '@keystar/ui/style';
...
const Dialog = /*#__PURE__*/forwardRef(function Dialog(props, forwardedRef) {
  ...
  let slots = useMemo(() => ({
    heading: {
      ...
      UNSAFE_className: classNames(slotClassNames.heading, getHeadingStyles()),
      elementType: 'h2',
      size: headingSize,
    ...
    buttonGroup: {
      ...
      UNSAFE_className: classNames(slotClassNames.buttonGroup, getButtonGroupStyles()),
      align: 'end'
    }
...
function useDialogStyleProps(props, sizeVariant) {
  ...
  return {
    ...
    ...styleProps,
    className: classNames(slotClassNames.root, css({
      display: 'flex',
      maxHeight: 'inherit',
      maxWidth: '100%',
      outline: 0,
...
function getContentStyles() {
  return css({
    ...
    background: [
    // masks
    `linear-gradient(${tokenSchema.color.background.surface}, transparent) center top`, `linear-gradient(transparent, ${tokenSchema.color.background.surface}) center bottom`,
    // dividers
    `linear-gradient(${tokenSchema.color.border.neutral}, ${tokenSchema.color.border.neutral}) center top`, `linear-gradient(${tokenSchema.color.border.neutral}, ${tokenSchema.color.border.neutral}) center bottom`].join(', '),
    ...
    paddingBlockStart: `calc(${tokenSchema.typography.text.regular.capheightTrim} * -0.1)`,
