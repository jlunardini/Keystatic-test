...
import { useStyleProps, useResponsiveValue, classNames, css, filterStyleProps, ClassList, toDataAttributes, tokenSchema, resolvePropWithPath, resolveProp, sizeResolver } from '@keystar/ui/style';
...
const Divider = forwardRefWithAs((props, forwardedRef) => {
  ...
  return /*#__PURE__*/jsx(Element, {
    ...
    ref: forwardedRef,
    className: classNames(dividerClassList.root(), css({
      alignSelf: 'stretch',
...
export { AspectRatio, Box, Divider, Flex, Grid, HStack, Surface, VStack, fitContent, minmax, repeat, useFlexStyleProps, useGridStyleProps, useSurface };
