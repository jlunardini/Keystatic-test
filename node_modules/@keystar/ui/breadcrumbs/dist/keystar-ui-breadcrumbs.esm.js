...
const breadcrumbsClassList = new ClassList('Breadcrumbs');
  ...
  return /*#__PURE__*/jsxs(Fragment, {
    children: [/*#__PURE__*/jsx(FocusRing, {
      children: /*#__PURE__*/jsx("span", {
        ...
        ref: ref,
        className: classNames(breadcrumbsClassList.declare('link'), css({
...
function Breadcrumbs(props, ref) {
  ...
  let breadcrumbItems = contents.map((child, index) => {
    ...
    return /*#__PURE__*/jsx("li", {
      className: classNames(breadcrumbsClassList.declare('item'), css({
        alignItems: 'center',
        display: 'inline-flex',
        whiteSpace: 'nowrap',
        '&:last-child': {
  ...
  return /*#__PURE__*/jsx("nav", {
    ...
    children: /*#__PURE__*/jsx("ul", {
      ref: listRef,
      className: classNames(breadcrumbsClassList.declare('list'), css({
        display: 'flex',
