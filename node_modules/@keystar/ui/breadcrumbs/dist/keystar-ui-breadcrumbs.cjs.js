...
const breadcrumbsClassList = new style.ClassList('Breadcrumbs');
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(React.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx(style.FocusRing, {
      children: /*#__PURE__*/jsxRuntime.jsx("span", {
        ...
        ref: ref,
        className: style.classNames(breadcrumbsClassList.declare('link'), style.css({
...
function Breadcrumbs(props, ref) {
  ...
  let breadcrumbItems = contents.map((child, index) => {
    ...
    return /*#__PURE__*/jsxRuntime.jsx("li", {
      className: style.classNames(breadcrumbsClassList.declare('item'), style.css({
        alignItems: 'center',
        display: 'inline-flex',
        whiteSpace: 'nowrap',
        '&:last-child': {
  ...
  return /*#__PURE__*/jsxRuntime.jsx("nav", {
    ...
    ...styleProps,
    ref: domRef,
    className: style.classNames(breadcrumbsClassList.root(), styleProps.className),
    children: /*#__PURE__*/jsxRuntime.jsx("ul", {
      ref: listRef,
      className: style.classNames(breadcrumbsClassList.declare('list'), style.css({
        display: 'flex',
