...
var persistedExchange = options => ({
  ...
  var operationFilter = operation => supportsPersistedQueries && !operation.context.persistAttempt && (enableForMutation && operation.kind === 'mutation' || operation.kind === 'query');
  return operations$ => {
