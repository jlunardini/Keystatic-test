...
const blockquoteDOM = ['blockquote', {
  class: `${classes.blockParent} ${style.css({
    marginInline: 0,
    paddingInline: style.tokenSchema.size.space.large,
    borderInlineStartStyle: 'solid',
    borderInlineStartWidth: style.tokenSchema.size.border.large,
...
const dividerDOM = ['hr', {
  ...
  class: style.css({
    ...
    border: 0,
    height: style.tokenSchema.size.border.large,
    padding: 0,
    cursor: 'pointer'
  })
}];
...
const listClass = `${blockElementSpacing} ${style.css({
  ...
  link: {
    ...
    parseDOM: [{
      ...
      getAttrs(node) {
        ...
        return {
          href,
          title: (_node$getAttribute = node.getAttribute('title')) !== null && _node$getAttribute !== void 0 ? _node$getAttribute : ''
        };
      }
    }],
    toDOM(node) {
...
function createEditorSchema(markdocConfig) {
  ...
  const editorSchema = {
    ...
    nodes,
    markdocConfig,
    insertMenuItems: insertMenuItems.sort((a, b) => a.label.localeCompare(b.label)).map((item, i) => ({
      ...item,
      id: i.toString()
    }))
  };
...
function EditorToolbarButton(props) {
  ...
  const isSelected = (_props$isSelected = props.isSelected) === null || _props$isSelected === void 0 ? void 0 : _props$isSelected.call(props, state);
...
function Toolbar() {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(ToolbarContainer, {
    children: [/*#__PURE__*/jsxRuntime.jsxs(ToolbarScrollArea, {
      children: [/*#__PURE__*/jsxRuntime.jsx(HeadingMenu, {
        headingType: nodes.heading
      }), /*#__PURE__*/jsxRuntime.jsx(InlineMarks, {}), /*#__PURE__*/jsxRuntime.jsx(ListButtons, {}), /*#__PURE__*/jsxRuntime.jsxs(ToolbarGroup, {
        children: [/*#__PURE__*/jsxRuntime.jsxs(tooltip.TooltipTrigger, {
          children: [/*#__PURE__*/jsxRuntime.jsx(EditorToolbarButton, {
          ...
          children: [/*#__PURE__*/jsxRuntime.jsx(EditorToolbarButton, {
            "aria-label": "Quote",
            command: prosemirrorCommands.wrapIn(nodes.blockquote),
            children: /*#__PURE__*/jsxRuntime.jsx(icon.Icon, {
...
const ToolbarContainer = ({
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(layout.Flex, {
    ...
    zIndex: 2,
    insetTop: 0,
    children: [children, /*#__PURE__*/jsxRuntime.jsx(layout.Flex, {
...
function InlineMarks() {
  ...
  return React.useMemo(() => {
    return /*#__PURE__*/jsxRuntime.jsx(actionGroup.ActionGroup, {
      ...
      onAction: key => {
        var _inlineMarks$find;
        const command = (_inlineMarks$find = inlineMarks.find(mark => mark.key === key)) === null || _inlineMarks$find === void 0 ? void 0 : _inlineMarks$find.command;
        if (command) {
          runCommand(command);
        }
      },
...
function ListButtons() {
  ...
  return React.useMemo(() => {
    return /*#__PURE__*/jsxRuntime.jsx(actionGroup.ActionGroup, {
      ...
      density: "compact",
      prominence: "low",
      disabledKeys: [canWrapInOrderedList && 'ordered', canWrapInUnorderedList && 'unordered'].filter(removeFalse),
      summaryIcon: /*#__PURE__*/jsxRuntime.jsx(icon.Icon, {
      ...
      items: [!!schema.nodes.unordered_list && {
        label: 'Bullet List',
        key: 'unordered',
        shortcut: '-',
      ...
      children: item => /*#__PURE__*/jsxRuntime.jsxs(actionGroup.Item, {
        textValue: `${item.label} (${item.shortcut})`,
        children: [/*#__PURE__*/jsxRuntime.jsx(icon.Icon, {
          src: item.icon
...
function CodeBlockLanguageCombobox(props) {
  ...
  const labelForVal = props.value ? (_aliasesToLabel$get = languages.aliasesToLabel.get(props.value)) !== null && _aliasesToLabel$get !== void 0 ? _aliasesToLabel$get : props.value : 'Plain text';
  ...
  return /*#__PURE__*/jsxRuntime.jsx(combobox.Combobox, {
    ...
    selectedKey: props.value ? (_aliasesToCanonicalNa = languages.aliasesToCanonicalName.get(props.value)) !== null && _aliasesToCanonicalNa !== void 0 ? _aliasesToCanonicalNa : null : 'plain',
    items: React.useMemo(() => languages.labelToCanonicalName.has(inputValue) ? languages.languagesWithAliases : matchSorter.matchSorter(languages.languagesWithAliases, inputValue, {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(CodeBlockLanguageCombobox, {
        ...
        onChange: val => {
          dispatchCommand((state, dispatch) => {
            if (dispatch) {
              dispatch(state.tr.setNodeMarkup(props.pos, undefined, {
                ...props.node.attrs,
                language: val
              }));
            }
...
function PopoverInner(props) {
  ...
  return reference && /*#__PURE__*/jsxRuntime.jsx(EditorPopover, {
    reference: reference,
    placement: "bottom",
...
const Editor = /*#__PURE__*/React.forwardRef(function Editor(props, ref) {
  return /*#__PURE__*/jsxRuntime.jsxs(ProseMirrorEditor, {
    value: props.value,
    ...
    children: [/*#__PURE__*/jsxRuntime.jsxs(layout.Box, {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(Toolbar, {}), /*#__PURE__*/jsxRuntime.jsx(ProseMirrorEditable, {
        className: editableStyles
      })]
    }), /*#__PURE__*/jsxRuntime.jsx(EditorPopoverDecoration, {
      state: props.value
...
function EditorAutocomplete(props) {
  ...
  return referenceElement && /*#__PURE__*/jsxRuntime.jsx(EditorPopover, {
...
function InsertMenu(props) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(EditorAutocomplete, {
    ...
    items: options,
    children: childRenderer$1,
    onEscape: () => {
      var _viewRef$current2;
      (_viewRef$current2 = viewRef.current) === null || _viewRef$current2 === void 0 || _viewRef$current2.dispatch(removeAutocompleteDecoration(editorState.tr));
    },
    onAction: key => {
...
function inline(fragment) {
  return [new Markdoc.Ast.Node('inline', {}, textblockChildren(fragment))];
}

// TODO: this should handle marks spanning over multiple text nodes properly
function textblockChildren(fragment) {
  const children = [];
  fragment.forEach(child => {
...
function proseMirrorToMarkdoc(node) {
  ...
  if (node.type === schema.nodes.list_item) {
    return new Markdoc.Ast.Node('item', {}, blocks(node.content));
  }
...
function createAndFill(markdocNode, nodeType, attrs, extraChildren) {
...
function markdocToProseMirror(node, schema) {
  state = {
    schema,
    errors: [],
    marks: []
...
function markdocNodeToProseMirrorNode(node) {
  ...
  if (node.type === 'item') {
    var _node$children$;
    if (((_node$children$ = node.children[0]) === null || _node$children$ === void 0 ? void 0 : _node$children$.type) === 'inline') {
      node = new Markdoc.Ast.Node('item', node.attributes, [new Markdoc.Ast.Node('paragraph', {}, node.children)]);
    }
  ...
  return new prosemirrorState.Plugin({
    props: {
      ...
      clipboardTextSerializer(content, view) {
        try {
          return Markdoc__default["default"].format(proseMirrorToMarkdoc(view.state.doc.type.create({}, content.content)));
        } catch (err) {
      ...
      clipboardTextParser(text, $context, plain, view) {
        try {
          return prosemirrorModel.Slice.maxOpen(markdocToProseMirror(Markdoc__default["default"].parse(text), getEditorSchema(view.state.schema)).content);
        } catch (err) {
...
function getDecorationsForIndividualNode(node) {
  ...
  if (typeof lang !== 'string' || !Object.prototype.hasOwnProperty.call(languages.Prism.languages, node.attrs.language)) {
    return emptyDecorations;
  }
  const decorations = [];
  const tokens = languages.Prism.tokenize(text, languages.Prism.languages[node.attrs.language]);
...
function createEditorState(doc, selection, storedMarks) {
  ...
  return prosemirrorState.EditorState.create({
    selection,
    storedMarks,
    plugins: [keydownHandler(), prosemirrorHistory.history(), dropCursor(), inputRules({
      rules: inputRulesForSchema(schema)
    }), attributes(), gapCursor(), prosemirrorKeymap.keymap(keymapForSchema(schema)), markdocClipboard(), nodeInSelectionDecorations(), autocompleteDecoration(), codeBlockSyntaxHighlighting()],
    doc
  });
}
...
function parseToEditorState(content, schema) {
  const markdoc = textDecoder$1.decode(content);
  const doc = markdocToProseMirror(Markdoc__default["default"].parse(markdoc), schema);
...
function serializeFromEditorState(value) {
  ...
  return textEncoder.encode(Markdoc__default["default"].format(Markdoc__default["default"].parse(markdoc)));
}
