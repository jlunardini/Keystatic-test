...
import React, { useRef, useCallback, useEffect, useContext, forwardRef, useImperativeHandle, useMemo, useLayoutEffect, useState } from 'react';
import { Flex, Divider, Box } from '@keystar/ui/layout';
import { css as css$1 } from '@emotion/css';
import { css, tokenSchema, useStyleProps, classNames } from '@keystar/ui/style';
...
import { NodeSelection, Selection, TextSelection, PluginKey, Plugin, EditorState, AllSelection } from 'prosemirror-state';
import { Item, ActionGroup } from '@keystar/ui/action-group';
...
import { Text, Kbd, Heading } from '@keystar/ui/typography';
import { NodeRange, Fragment, Slice, Schema, Node, MarkType, DOMSerializer, DOMParser } from 'prosemirror-model';
import { findWrapping, ReplaceAroundStep, canSplit, liftTarget, canJoin, StepMap, dropPoint } from 'prosemirror-transform';
...
import { l as localizedMessages, i as isValidURL, a as aliasesToLabel, b as aliasesToCanonicalName, c as canonicalNameToLabel, d as labelToCanonicalName, e as languagesWithAliases, P as Prism } from '../../../../dist/languages-40dfdbbf.node.esm.js';
...
import { useListBoxLayout, ListBoxBase, listStyles, Item as Item$2 } from '@keystar/ui/listbox';
import { useFloating, autoUpdate, FloatingPortal, offset, shift, limitShift, flip, size, inline as inline$1 } from '@floating-ui/react';
import '@react-aria/focus';
import '@react-aria/interactions';
import '@react-stately/utils';
import 'emery';
import weakMemoize$1 from '@emotion/weak-memoize';
import { closeHistory, undo, redo, history } from 'prosemirror-history';
...
function Toolbar() {
  ...
  return /*#__PURE__*/jsxs(ToolbarContainer, {
    children: [/*#__PURE__*/jsxs(ToolbarScrollArea, {
      children: [/*#__PURE__*/jsx(HeadingMenu, {
        headingType: nodes.heading
      }), /*#__PURE__*/jsx(InlineMarks, {}), /*#__PURE__*/jsx(ListButtons, {}), /*#__PURE__*/jsxs(ToolbarGroup, {
...
const ToolbarContainer = ({
  ...
  return /*#__PURE__*/jsxs(Flex, {
    ...
    zIndex: 2,
    insetTop: 0,
    children: [children, /*#__PURE__*/jsx(Flex, {
...
const Editor = /*#__PURE__*/forwardRef(function Editor(props, ref) {
  return /*#__PURE__*/jsxs(ProseMirrorEditor, {
    value: props.value,
    ...
    children: [/*#__PURE__*/jsxs(Box, {
      ...
      children: [/*#__PURE__*/jsx(Toolbar, {}), /*#__PURE__*/jsx(ProseMirrorEditable, {
        className: editableStyles
      })]
    }), /*#__PURE__*/jsx(EditorPopoverDecoration, {
      state: props.value
...
function markdocNodeToProseMirrorNode(node) {
  ...
  if (node.type === 'item') {
    ...
    if (((_node$children$ = node.children[0]) === null || _node$children$ === void 0 ? void 0 : _node$children$.type) === 'inline') {
      node = new Ast.Node('item', node.attributes, [new Ast.Node('paragraph', {}, node.children)]);
    }
  ...
  return new Plugin({
    props: {
      ...
      clipboardTextParser(text, $context, plain, view) {
        try {
          return Slice.maxOpen(markdocToProseMirror(Markdoc.parse(text), getEditorSchema(view.state.schema)).content);
        } catch (err) {
...
function createEditorState(doc, selection, storedMarks) {
  ...
  return EditorState.create({
    selection,
    storedMarks,
    plugins: [keydownHandler(), history(), dropCursor(), inputRules({
      rules: inputRulesForSchema(schema)
    }), attributes(), gapCursor(), keymap(keymapForSchema(schema)), markdocClipboard(), nodeInSelectionDecorations(), autocompleteDecoration(), codeBlockSyntaxHighlighting()],
    doc
  });
}
