...
var languages = require('./languages-e9a3f1a7.node.cjs.js');
...
function toMarkdocInline(node) {
  ...
  let markdocNode = new Markdoc.Ast.Node('text', {
    content: node.text
  });
  for (const mark of marks) {
...
function BlockPopover(props) {
  ...
  return (
    ...
    jsxRuntime.jsx(overlays$2.Overlay, {
      isOpen: state.isOpen,
      nodeRef: wrapperRef,
...
function LinkDialog({
  ...
  const showInvalidState = touched && !languages.isValidURL(href);
...
function CodeElement({
  ...
  const editor = slateReact.useSlateStatic();
  const triggerRef = React.useRef(null);
  const [inputValue, setInputValue] = React.useState(element.language ? (_aliasesToLabel$get = languages.aliasesToLabel.get(element.language)) !== null && _aliasesToLabel$get !== void 0 ? _aliasesToLabel$get : element.language : 'Plain text');
  const [dialogOpen, setDialogOpen] = React.useState(false);
  const {
    documentFeatures
          ...
          children: /*#__PURE__*/jsxRuntime.jsxs(layout.Flex, {
            ...
            children: [/*#__PURE__*/jsxRuntime.jsx(combobox.Combobox, {
              ...
              onBlur: () => {
                ...
                const canonicalName = languages.aliasesToCanonicalName.get(inputValue);
                if (canonicalName !== undefined) {
                  ...
                  setInputValue(languages.canonicalNameToLabel.get(canonicalName));
                ...
                const nameFromLabel = languages.labelToCanonicalName.get(inputValue);
              ...
              onSelectionChange: selection => {
                const path = slateReact.ReactEditor.findPath(editor, element);
                if (languages.aliasesToCanonicalName.has(inputValue)) {
                  selection = languages.aliasesToCanonicalName.get(inputValue);
                }
                if (selection === null) {
                  if (inputValue === '') {
                    slate.Transforms.unsetNodes(editor, 'language', {
                  ...
                  const label = languages.canonicalNameToLabel.get(selection);
                  if (label) {
                    setInputValue(label);
                  }
                }
              },
              selectedKey: element.language ? languages.aliasesToCanonicalName.get(element.language) : 'plain',
              items: React.useMemo(() => inputValue === 'Plain text' || languages.labelToCanonicalName.has(inputValue) ? languages.languagesWithAliases : matchSorter.matchSorter(languages.languagesWithAliases, inputValue, {
...
function ComponentBlockRender({
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(ChildrenByPathContext.Provider, {
    ...
    children: [React.useMemo(() => /*#__PURE__*/jsxRuntime.jsx(ComponentBlockPreview, {
      onRemove: onRemove,
      ...previewProps
    }), [ComponentBlockPreview, onRemove, previewProps]), /*#__PURE__*/jsxRuntime.jsx("span", {
      className: style.css({
...
function ChromefulComponentBlockElement(props) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(BlockPrimitive, {
    ...
    children: /*#__PURE__*/jsxRuntime.jsxs(layout.Flex, {
      ...
      }), editMode ? /*#__PURE__*/jsxRuntime.jsxs(React.Fragment, {
        children: [/*#__PURE__*/jsxRuntime.jsx(FormValue, {
          isValid: isValid,
...
function ImageFieldInput(props) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(layout.Flex, {
    ...
    }), (props.forceValidation || blurred) && ((_props$validation = props.validation) === null || _props$validation === void 0 ? void 0 : _props$validation.isRequired) && value === null && /*#__PURE__*/jsxRuntime.jsxs(field.FieldMessage, {
...
function Toolbar({
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(ToolbarWrapper, {
    children: [/*#__PURE__*/jsxRuntime.jsxs(ToolbarScrollArea, {
      ...
      }), (documentFeatures.dividers || documentFeatures.links || !!documentFeatures.images || documentFeatures.formatting.blockTypes.blockquote || documentFeatures.tables || !!documentFeatures.layouts.length || documentFeatures.formatting.blockTypes.code) && /*#__PURE__*/jsxRuntime.jsxs(ToolbarGroup, {
    ...
    }, [viewState]), !!hasBlockItems && /*#__PURE__*/jsxRuntime.jsx(InsertBlockMenu, {})]
  });
}
...
function withCodeBlock(documentFeatures, componentBlocks, editor) {
  ...
  function codeBlockShortcut(block) {
    ...
    slate.Transforms.wrapNodes(editor, {
      type: 'code',
      ...(match[1] ? {
        language: (_aliasesToCanonicalNa = languages.aliasesToCanonicalName.get(match[1].toLowerCase())) !== null && _aliasesToCanonicalNa !== void 0 ? _aliasesToCanonicalNa : match[1]
      } : {}),
      children: []
    }, {
      match: node => node.type === 'paragraph'
...
function withPasting(editor) {
  ...
  editor.insertTextData = data => {
    ...
    urlPattern.test(plain) && languages.isValidURL(plain) && editor.selection && !slate.Range.isCollapsed(editor.selection) &&
    ...
    children: /*#__PURE__*/jsxRuntime.jsx(typography.Prose, {
      ...
      children: /*#__PURE__*/jsxRuntime.jsx(slateReact.Editable, {
        ...
        decorate: React.useCallback(([node, path]) => {
          ...
          if (node.type === 'code' && node.children.length === 1 && node.children[0].type === undefined && node.language && node.language in languages.Prism.languages) {
            const textPath = [...path, 0];
            const tokens = languages.Prism.tokenize(node.children[0].text, languages.Prism.languages[node.language]);
...
exports.keyedEntries = keyedEntries;
exports.mergeDataStates = mergeDataStates;
