...
import { Text, Element as Element$1, Transforms, Editor, Node, Path, Range, Point, createEditor } from 'slate';
...
new Map(languages.map(x => [x.label, x.value]));
...
new Map([...aliasesToCanonicalName].map(([alias, canonicalName]) => [alias, canonicalNameToLabel.get(canonicalName)]));
...
export { getCollectionItemPath as A, getDataFileExtension as B, getRepoUrl as C, keyedEntries as D, getSingletonFormat as E, FieldDataError as F, basicFormFieldWithSimpleReaderParse as G, assertRequired as H, getSrcPrefix as I, fixPath as J, KEYSTATIC_CLOUD_API_URL as K, validateText as L, text as M, document$1 as N, sha1 as O, getValueAtPropPath as P, getSingletonPath as a, getTreeNodeAtPath as b, treeSha as c, KEYSTATIC_CLOUD_HEADERS as d, isCloudConfig as e, getCollectionPath as f, getEntriesInCollectionWithTreeKey as g, isLocalConfig as h, isGitHubConfig as i, getKeysForArrayValue as j, getSlugFromState as k, getInitialPropsValue as l, getDirectoriesForTreeKey as m, getTreeKey as n, object as o, pluralize as p, getEntryDataFilepath as q, redirectToCloudAuth as r, setKeysForArrayValue as s, treeEntriesToTreeNodes as t, updateValue as u, blobSha as v, updateTreeWithChanges as w, serializeProps as x, getCollectionFormat as y, getSlugGlobForCollection as z };
