...
import { Text as Text$1, Element, Transforms, Editor, Node, Path, Range, Point, createEditor } from 'slate';
...
import React, { createContext, useContext, useState, useMemo, useEffect, useCallback, useRef, useId, memo, cloneElement, forwardRef, Fragment as Fragment$1, useReducer, createElement } from 'react';
import { TextArea, TextField } from '@keystar/ui/text-field';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import { FieldMessage, FieldLabel, Field } from '@keystar/ui/field';
import { Box, Flex, Grid, Divider } from '@keystar/ui/layout';
...
import { l as localizedMessages, i as isValidURL, a as aliasesToLabel, b as aliasesToCanonicalName, c as canonicalNameToLabel, d as labelToCanonicalName, e as languagesWithAliases, P as Prism } from './languages-40dfdbbf.node.esm.js';
import { css, tokenSchema, breakpointQueries, breakpoints, useBreakpoint, transition, toDataAttributes, classNames } from '@keystar/ui/style';
...
import { useModalOverlay, DismissButton, useOverlay, useOverlayPosition, useOverlayTrigger } from '@react-aria/overlays';
import { useResizeObserver, useUpdateEffect, useLayoutEffect, mergeProps } from '@react-aria/utils';
import { useOverlayTriggerState } from '@react-stately/overlays';
import { Badge } from '@keystar/ui/badge';
import { Blanket, Overlay, Popover } from '@keystar/ui/overlays';
...
import { MenuTrigger, Menu, Item as Item$3 } from '@keystar/ui/menu';
...
import { Item as Item$4, useListBoxLayout, ListBoxBase } from '@keystar/ui/listbox';
...
function ComponentBlockRender({
  ...
  return /*#__PURE__*/jsxs(ChildrenByPathContext.Provider, {
    ...
    children: [useMemo(() => /*#__PURE__*/jsx(ComponentBlockPreview, {
      onRemove: onRemove,
      ...previewProps
    }), [ComponentBlockPreview, onRemove, previewProps]), /*#__PURE__*/jsx("span", {
      className: css({
...
function ChromefulComponentBlockElement(props) {
  ...
  return /*#__PURE__*/jsx(BlockPrimitive, {
    ...
    children: /*#__PURE__*/jsxs(Flex, {
      ...
      }), editMode ? /*#__PURE__*/jsxs(Fragment$1, {
        children: [/*#__PURE__*/jsx(FormValue, {
          isValid: isValid,
      ...
      children: [/*#__PURE__*/jsx("div", {
        ...
        children: /*#__PURE__*/jsxs(Flex, {
          ...
          children: [/*#__PURE__*/jsx(ActionGroup, {
            ...
            children: layoutOptions.map((layoutOption, i) => /*#__PURE__*/jsx(Item$1, {
...
function ListButtons(props) {
  ...
  return useMemo(() => {
    ...
    return /*#__PURE__*/jsx(ActionGroup, {
      ...
      children: [props.lists.unordered && /*#__PURE__*/jsxs(Item$1, {
      ...
      }, "unordered"), props.lists.ordered && /*#__PURE__*/jsxs(Item$1, {
...
function ImageFieldInput(props) {
  ...
  return /*#__PURE__*/jsxs(Flex, {
    ...
    }), (props.forceValidation || blurred) && ((_props$validation = props.validation) === null || _props$validation === void 0 ? void 0 : _props$validation.isRequired) && value === null && /*#__PURE__*/jsxs(FieldMessage, {
...
function getSelectedTableArea(editor) {
  ...
  if (editor.selection && table && Element.isElement(table[0].children[0]) && anchor && focus && Path.equals(anchor.slice(0, -3), focus.slice(0, -3))) {
...
function withTable(editor) {
  ...
  editor.deleteFragment = direction => {
    ...
    if (!Element.isElement(headOrBody) || !Element.isElement(headOrBody.children[0])) {
      deleteFragment(direction);
      return;
    }
...
function Toolbar({
  ...
  return /*#__PURE__*/jsxs(ToolbarWrapper, {
    children: [/*#__PURE__*/jsxs(ToolbarScrollArea, {
      ...
      }), (documentFeatures.dividers || documentFeatures.links || !!documentFeatures.images || documentFeatures.formatting.blockTypes.blockquote || documentFeatures.tables || !!documentFeatures.layouts.length || documentFeatures.formatting.blockTypes.code) && /*#__PURE__*/jsxs(ToolbarGroup, {
    ...
    }, [viewState]), !!hasBlockItems && /*#__PURE__*/jsx(InsertBlockMenu, {})]
  });
}
...
function document$1({
  ...
  return {
    ...
    directories: [...collectDirectoriesUsedInSchema(object(Object.fromEntries(Object.entries(componentBlocks).map(([name, block]) => [name, object(block.schema)])))), ...(typeof documentFeatures.images === 'object' && typeof documentFeatures.images.directory === 'string' ? [documentFeatures.images.directory] : [])],
...
export { useChanged as $, updateTreeWithChanges as A, BranchInfoContext as B, CloudAppShellQuery as C, hydrateTreeCacheWithEntries as D, fetchGitHubTreeData as E, treeSha as F, GitHubAppShellQuery as G, serializeProps as H, getSlugFromState as I, getCollectionFormat as J, KEYSTATIC_CLOUD_API_URL as K, LOADING as L, getSlugGlobForCollection as M, getCollectionItemPath as N, mergeDataStates as O, PageRoot as P, PageBody as Q, Ref_base as R, containerWidthForEntryLayout as S, createGetPreviewProps as T, useBranchInfo as U, useEventCallback as V, clientSideValidateProp as W, FormForEntry as X, getDataFileExtension as Y, getRepoUrl as Z, getInitialPropsValue as _, PageHeader as a, keyedEntries as a0, pluralize as a1, useViewer as a2, useConfig as a3, isCloudConfig as a4, useAppState as a5, ZapLogo as a6, GitHubAppShellDataContext as a7, useSidebar as a8, useContentPanelState as a9, SlugFieldContext as aA, PathContext as aB, validateText as aC, ArrayFieldListView as aD, previewPropsToValue as aE, ArrayFieldValidationMessages as aF, valueToUpdater as aG, setValueToPreviewProps as aH, FormValueContentFromPreviewProps as aI, text as aJ, document$1 as aK, focusWithPreviousSelection as aL, getSplitCloudProject as aM, sha1 as aN, getValueAtPropPath as aO, formatFormDataError as aP, ContentPanelProvider as aa, SidebarDialog as ab, SidebarPanel as ac, AppShellErrorContext as ad, ConfigContext as ae, AppStateContext as af, SidebarProvider as ag, GitHubAppShellProvider as ah, LocalAppShellProvider as ai, getSingletonFormat as aj, getSingletonPath as ak, assertValidRepoConfig as al, RouterProvider as am, GitHubAppShellDataProvider as an, basicFormFieldWithSimpleReaderParse as ao, FieldDataError as ap, assertRequired as aq, BlockWrapper as ar, NotEditable as as, ToolbarSeparator as at, ImageFieldInput as au, getSrcPrefix as av, fixPath as aw, useIsInDocumentEditor as ax, useObjectURL as ay, getUploadedFile as az, useTree as b, getEntriesInCollectionWithTreeKey as c, useRepositoryId as d, getAuth as e, getDirectoriesForTreeKey as f, getCollectionPath as g, getTreeKey as h, isLocalConfig as i, useData as j, getTreeNodeAtPath as k, getEntryDataFilepath as l, isGitHubConfig as m, parseProps as n, object as o, parseRepoConfig as p, blobSha as q, KEYSTATIC_CLOUD_HEADERS as r, serializeRepoConfig as s, toFormattedFormDataError as t, useRouter as u, getSyncAuth as v, redirectToCloudAuth as w, useBaseCommit as x, useSetTreeSha as y, RepoWithWriteAccessContext as z };
