import { u as useImageLibraryURL, e as emptyImageData, p as parseImageData, i as integer } from './api-d174312a.node.esm.js';
export { c as component } from './api-d174312a.node.esm.js';
import { ao as basicFormFieldWithSimpleReaderParse, ap as FieldDataError, aq as assertRequired, au as ImageFieldInput, av as getSrcPrefix, aw as fixPath, ax as useIsInDocumentEditor, ay as useObjectURL, az as getUploadedFile, b as useTree, aA as SlugFieldContext, aB as PathContext, aC as validateText, _ as getInitialPropsValue, aD as ArrayFieldListView, aE as previewPropsToValue, aF as ArrayFieldValidationMessages, aG as valueToUpdater, aH as setValueToPreviewProps, T as createGetPreviewProps, W as clientSideValidateProp, aI as FormValueContentFromPreviewProps, V as useEventCallback, o as object, aJ as text, aK as document } from './index-a24a6569.node.esm.js';
export { ar as BlockWrapper, as as NotEditable, at as ToolbarSeparator } from './index-a24a6569.node.esm.js';
...
import { ButtonGroup, ActionButton, Button, ClearButton, ToggleButton } from '@keystar/ui/button';
import { FieldLabel, FieldMessage } from '@keystar/ui/field';
import { Flex, Box, VStack, HStack } from '@keystar/ui/layout';
import { Combobox, Item } from '@keystar/ui/combobox';
import { filter } from 'minimatch';
import { Item as Item$1 } from '@react-stately/collections';
import { u as useSlugsInCollection } from './useSlugsInCollection-605ee417.node.esm.js';
import { Picker, Item as Item$2 } from '@keystar/ui/picker';
import slugify from '@sindresorhus/slugify';
import { i as isValidURL, l as localizedMessages } from './languages-40dfdbbf.node.esm.js';
import 'emery';
...
function ImageField(props) {
  ...
  const dimensionsMatchOriginal = dimensions.width === image.width && dimensions.height === image.height;
  const [lastPastedUrl, setLastPastedUrl] = useState(null);
  const onPaste = event => {
    event.preventDefault();
  ...
  const onLoad = useEventCallback(img => {
    const dimensions = {
      width: img.width,
      height: img.height
    };
...
export { collection, config, index as fields, singleton };
