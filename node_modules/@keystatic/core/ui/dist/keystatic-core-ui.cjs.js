...
var languages = require('../../dist/languages-2db7c638.cjs.js');
var index = require('../../dist/index-8ea08ba8.cjs.js');
...
var useSlugsInCollection = require('../../dist/useSlugsInCollection-d721937b.cjs.js');
...
function CollectionPageHeader(props) {
  ...
  const stringFormatter = i18n.useLocalizedStringFormatter(languages.localizedMessages);
...
function BranchPicker() {
  const {
    ...
    currentBranch,
    defaultBranch
  } = React.useContext(index.BranchInfoContext);
  const stringFormatter = i18n.useLocalizedStringFormatter(languages.localizedMessages);
  const router = index.useRouter();
      ...
      if (args.config.storage.kind === 'github' || args.config.storage.kind === 'cloud') {
        ...
        if (gqlError && 'type' in gqlError) {
          ...
          if (gqlError.type === 'STALE_DATA') {
            ...
            const tree = await index.fetchGitHubTreeData(refData.data.repository.ref.target.oid, args.config);
...
function ItemPage(props) {
  ...
  const onUpdate = React.useCallback(async () => {
    if (!index.clientSideValidateProp(schema, state, props.slugInfo)) {
...
function ItemPageWrapper(props) {
  ...
  const allSlugs = useSlugsInCollection.useSlugsInCollection(props.collection);
  ...
  const combined = React.useMemo(() => index.mergeDataStates({
    item: itemData,
    tree
  }), [itemData, tree]);
...
function CreateItem(props) {
  ...
  const slugsArr = useSlugsInCollection.useSlugsInCollection(props.collection);
...
function useLocalizedString() {
  let stringFormatter = i18n.useLocalizedStringFormatter(languages.localizedMessages);
...
function GithubHeader({
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(HeaderOuter, {
    children: [/*#__PURE__*/jsxRuntime.jsx(BrandButton, {}), /*#__PURE__*/jsxRuntime.jsx(button.Button, {
      href: `https://github.com/${index.serializeRepoConfig(config.storage.repo)}`,
      target: "_blank",
      rel: "noopener noreferrer",
      prominence: "low",
      isHidden: {
      ...
      children: index.serializeRepoConfig(config.storage.repo)
    }), /*#__PURE__*/jsxRuntime.jsx(Slash, {}), /*#__PURE__*/jsxRuntime.jsx(BranchPicker, {}), /*#__PURE__*/jsxRuntime.jsx(GitMenu, {}), /*#__PURE__*/jsxRuntime.jsx(layout.Box, {
      flex: "1"
...
function BrandButton() {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(button.Button, {
    ...
    children: /*#__PURE__*/jsxRuntime.jsx(index.ZapLogo, {})
  });
}
function Slash() {
...
function GitMenu() {
  ...
  const stringFormatter = i18n.useLocalizedStringFormatter(languages.localizedMessages);
  const data = React.useContext(index.BranchInfoContext);
  ...
  const [, deleteBranch] = urql.useMutation(noTransform.gql`
    ...
    `);
  const appShellData = React.useContext(index.GitHubAppShellDataContext);
...
const MainPanelLayout = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(index.ContentPanelProvider, {
    ...
    children: /*#__PURE__*/jsxRuntime.jsxs(splitView.SplitView, {
      ...
      maxSize: 400,
      flex: true,
      children: [isBelowDesktop ? /*#__PURE__*/jsxRuntime.jsx(index.SidebarDialog, {
        hrefBase: basePath,
        config: config
