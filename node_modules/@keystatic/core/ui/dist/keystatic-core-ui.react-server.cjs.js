...
var index = require('../../dist/index-63269275.react-server.cjs.js');
...
var requiredFiles = require('../../dist/required-files-99a2d1f2.react-server.cjs.js');
require('slate');
require('slate-react');
...
var listTodoIcon = require('@keystar/ui/icon/icons/listTodoIcon');
...
var refreshCwIcon = require('@keystar/ui/icon/icons/refreshCwIcon');
...
function GitHubAppShellProvider(props) {
  ...
  const branchInfo = React.useMemo(() => {
    ...
    return {
      ...
      allBranches: (_repo$refs$nodes$map$ = (_repo10 = repo) === null || _repo10 === void 0 || (_repo10 = _repo10.refs) === null || _repo10 === void 0 || (_repo10 = _repo10.nodes) === null || _repo10 === void 0 ? void 0 : _repo10.map(x => x === null || x === void 0 ? void 0 : x.name).filter(emery.isDefined)) !== null && _repo$refs$nodes$map$ !== void 0 ? _repo$refs$nodes$map$ : [],
      hasPullRequests: !!(currentBranchRef !== null && currentBranchRef !== void 0 && currentBranchRef.associatedPullRequests.totalCount),
      branchNameToId: new Map((_repo11 = repo) === null || _repo11 === void 0 || (_repo11 = _repo11.refs) === null || _repo11 === void 0 || (_repo11 = _repo11.nodes) === null || _repo11 === void 0 ? void 0 : _repo11.filter(emery.isDefined).map(x => [x.name, x.id])),
...
function ZapLogo() {
  return /*#__PURE__*/jsxRuntime.jsx("svg", {
    viewBox: "0 0 24 24",
    fill: style.tokenSchema.color.foreground.neutral,
    className: style.css({
      flexShrink: 0,
      height: style.tokenSchema.size.scale[250],
      width: style.tokenSchema.size.scale[250],
...
function SidebarPanel(props) {
  return /*#__PURE__*/jsxRuntime.jsx(layout.Flex, {
    ...
    direction: "column",
    height: "100%",
    children: /*#__PURE__*/jsxRuntime.jsx(SidebarNav, {
      ...props
    })
  });
}
function SidebarHeader() {
  ...
  let text = 'Keystatic';
  if (index.isCloudConfig(config)) {
    text = config.cloud.project;
  }
  if (index.isGitHubConfig(config)) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(layout.Flex, {
    ...
    paddingX: "xlarge",
    children: [/*#__PURE__*/jsxRuntime.jsx(ZapLogo, {}), /*#__PURE__*/jsxRuntime.jsx(typography.Text, {
      color: "neutralEmphasis",
      weight: "semibold",
      children: text
    })]
...
function SidebarDialog(props) {
  ...
  let {
    modalProps,
    underlayProps
  } = overlays$1.useModalOverlay({
    isDismissable: true
  }, state, dialogRef);
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx(overlays$2.Blanket, {
      ...underlayProps,
      isOpen: state.isOpen,
      zIndex: 10
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(SidebarHeader, {}), /*#__PURE__*/jsxRuntime.jsx(SidebarNav, {
        ...props
      }), /*#__PURE__*/jsxRuntime.jsx(overlays$1.DismissButton, {
...
function SidebarNav(props) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx("div", {
    ...
    children: /*#__PURE__*/jsxRuntime.jsxs(navList.NavList, {
      children: [/*#__PURE__*/jsxRuntime.jsx(navList.NavItem, {
      ...
      }), collectionsArray.length !== 0 && /*#__PURE__*/jsxRuntime.jsx(navList.NavGroup, {
        ...
        children: collectionsArray.map(([key, collection]) => {
          ...
          return /*#__PURE__*/jsxRuntime.jsxs(navList.NavItem, {
            ...
            }), !!allChangesCount && /*#__PURE__*/jsxRuntime.jsxs(badge.Badge, {
              tone: "accent",
              marginStart: "auto",
              children: [/*#__PURE__*/jsxRuntime.jsx(typography.Text, {
                ...
                visuallyHidden: true,
                children: index.pluralize(allChangesCount, {
                  singular: 'change',
                  plural: 'changes',
                  inclusive: false
                })
      ...
      }), singletonsArray.length !== 0 && /*#__PURE__*/jsxRuntime.jsx(navList.NavGroup, {
        ...
        children: singletonsArray.map(([key, collection]) => {
          ...
          return /*#__PURE__*/jsxRuntime.jsxs(navList.NavItem, {
            ...
            children: [/*#__PURE__*/jsxRuntime.jsx(typography.Text, {
              ...
              title: collection.label,
              children: collection.label
            }), changedData.singletons.has(key) && /*#__PURE__*/jsxRuntime.jsx(layout.Box, {
...
function CollectionTable(props) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(table.TableView, {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx(table.TableHeader, {
      ...
      items: sortedItems,
      children: item => isLocalMode ? /*#__PURE__*/jsxRuntime.jsx(table.Row, {
...
function BranchPicker() {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(picker.Picker, {
    ...
    children: item => /*#__PURE__*/jsxRuntime.jsxs(picker.Item, {
      textValue: item.name,
      children: [/*#__PURE__*/jsxRuntime.jsx(icon.Icon, {
...
function ObjectFieldInput({
  ...
  const inner = /*#__PURE__*/jsxRuntime.jsx(layout.Flex, {
    gap: "xlarge",
    direction: "column",
    children: Object.entries(fields).map(([key, propVal]) => isNonChildFieldPreviewProps(propVal) && /*#__PURE__*/jsxRuntime.jsx(AddToPathProvider, {
      part: key,
...
function ConditionalFieldInput({
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(layout.Flex, {
    ...
    }), [autoFocus, schemaDiscriminant, discriminant, onChange, forceValidation]), isNonChildFieldPreviewProps(value) && /*#__PURE__*/jsxRuntime.jsx(AddToPathProvider, {
      part: "value",
      children: /*#__PURE__*/jsxRuntime.jsx(InnerFormValueContentFromPreviewProps, {
        forceValidation: forceValidation,
        ...value
...
function fetchBlob(config, oid, filepath) {
  ...
  const promise = (index.isGitHubConfig(config) || config.storage.kind === 'cloud' ? fetchGitHubBlob(config, oid) : fetch(`/api/keystatic/blob/${oid}/${filepath}`, {
    headers: {
      'no-cors': '1'
    }
...
function createUrqlClient(config) {
  ...
  return urql.createClient({
    ...
    exchanges: [urql.dedupExchange, exchangeAuth.authExchange(async utils => {
...
function Provider({
  ...
  const UniversalLink = React.useMemo(() => link.makeLinkComponent(({
    href,
    onClick,
    rel,
    ...props
    ...
    return shouldUseNext ? /*#__PURE__*/jsxRuntime.jsx(Link, {
      href: href,
      ref: ref,
      ...props
  ...
  return /*#__PURE__*/jsxRuntime.jsx(ThemeProvider, {
    value: themeContext,
    children: /*#__PURE__*/jsxRuntime.jsxs(core.VoussoirProvider, {
  ...
  return [state, async override => {
    try {
      ...
      additions = additions.filter(addition => {
        ...
        const existing = index.getTreeNodeAtPath(args.currentTree, addition.path);
        return (existing === null || existing === void 0 ? void 0 : existing.entry.sha) !== sha;
      });
      const deletions = [...filesToDelete].map(path => ({
        path
      }));
      const updatedTree = await index.updateTreeWithChanges(args.currentTree, {
        additions,
...
function useHasChanged(args) {
  const initialFilesForUpdate = React.useMemo(() => args.initialState === null ? null : index.serializeProps(args.initialState, args.schema, args.slugField, args.slugField ? index.getSlugFromState({
  ...
  const filesForUpdate = React.useMemo(() => index.serializeProps(args.state, args.schema, args.slugField, args.slugField ? index.getSlugFromState({
    schema: args.schema.fields,
    slugField: args.slugField
...
function ItemPage(props) {
  ...
  const onView = () => {
    emery.assert(index.isGitHubConfig(config));
    let filePath = formatInfo.dataLocation === 'index' ? `/tree/${branchInfo.currentBranch}/${currentBasePath}` : `/blob/${branchInfo.currentBranch}/${currentBasePath}${index.getDataFileExtension(formatInfo)}`;
    window.open(`${index.getRepoUrl(branchInfo)}${filePath}`, '_blank', 'noopener,noreferrer');
  };
...
function HeaderActions(props) {
  ...
  const isGithub = index.isGitHubConfig(config);
  const stringFormatter = i18n.useLocalizedStringFormatter(l10nMessages);
...
function ItemPageWrapper(props) {
  ...
  const slugInfo = React.useMemo(() => {
    ...
    return {
      ...
      field: collectionConfig.slugField,
      slugs,
      glob: index.getSlugGlobForCollection(props.config, props.collection)
    };
  ...
  const combined = React.useMemo(() => mergeDataStates({
    item: itemData,
    tree
  }), [itemData, tree]);
...
function CreateItem(props) {
  ...
  const [forceValidation, setForceValidation] = React.useState(false);
  const schema = React.useMemo(() => index.object(collectionConfig.schema), [collectionConfig.schema]);
  const [state, setState] = React.useState(() => index.getInitialPropsValue(schema));
...
const DashboardCard = props => {
  let Link = link.useLinkComponent(null);
  return /*#__PURE__*/jsxRuntime.jsxs(layout.Flex, {
    alignItems: "center",
...
function BranchSection(props) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(DashboardSection, {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsxs(layout.Flex, {
      ...
      }), !isDefaultBranch && /*#__PURE__*/jsxRuntime.jsxs(button.ActionButton, {
...
function CollectionSection(props) {
  ...
  let collections = index.keyedEntries((_props$config$collect = props.config.collections) !== null && _props$config$collect !== void 0 ? _props$config$collect : {});
      ...
      children: collections.map(collection => {
        ...
        return /*#__PURE__*/jsxRuntime.jsx(DashboardCard, {
          ...
          endElement: /*#__PURE__*/jsxRuntime.jsxs(layout.Flex, {
            gap: "medium",
            alignItems: "center",
            children: [changes > 0 && /*#__PURE__*/jsxRuntime.jsx(badge.Badge, {
              tone: "accent",
              children: index.pluralize(changes, {
                singular: 'change',
                plural: 'changes'
              })
            }), /*#__PURE__*/jsxRuntime.jsx(button.ActionButton, {
          ...
          children: /*#__PURE__*/jsxRuntime.jsx(typography.Text, {
            color: "neutralSecondary",
            children: index.pluralize(totalCount, {
              singular: 'entry',
              plural: 'entries'
            })
          })
...
function SingletonSection(props) {
  ...
  let changed = useChanged();
  let singletons = index.keyedEntries((_props$config$singlet = props.config.singletons) !== null && _props$config$singlet !== void 0 ? _props$config$singlet : {});
    ...
    children: /*#__PURE__*/jsxRuntime.jsx(DashboardGrid, {
      children: singletons.map(singleton => {
        ...
        return /*#__PURE__*/jsxRuntime.jsx(DashboardCard, {
          ...
          endElement: changes ? /*#__PURE__*/jsxRuntime.jsx(badge.Badge, {
            tone: "accent",
            children: "Changed"
          }) : /*#__PURE__*/jsxRuntime.jsx(badge.Badge, {
            children: "Unchanged"
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(PageRoot, {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx(PageHeader, {
      ...
      children: /*#__PURE__*/jsxRuntime.jsxs(layout.Flex, {
        direction: "column",
        gap: "xxlarge",
        children: [user && /*#__PURE__*/jsxRuntime.jsxs(layout.Flex, {
          alignItems: "center",
          gap: "medium",
          isHidden: {
            below: 'tablet'
          ...
          children: [/*#__PURE__*/jsxRuntime.jsx(avatar.Avatar, {
            ...
            size: "large"
          }), /*#__PURE__*/jsxRuntime.jsxs(typography.Heading, {
            size: "medium",
            elementType: "p",
            UNSAFE_style: {
          ...
          config: props.config
        }), /*#__PURE__*/jsxRuntime.jsx(CollectionSection, {
          basePath: props.basePath,
          config: props.config
        }), /*#__PURE__*/jsxRuntime.jsx(SingletonSection, {
          basePath: props.basePath,
          config: props.config
        })]
      })
...
const TopBar = () => {
  let config = useConfig();
  if (index.isCloudConfig(config)) {
    return /*#__PURE__*/jsxRuntime.jsx(CloudHeader, {
      config: config
    });
  }
  if (index.isGitHubConfig(config)) {
    return /*#__PURE__*/jsxRuntime.jsx(GithubHeader, {
      config: config
    });
  }
  if (index.isLocalConfig(config)) {
    return /*#__PURE__*/jsxRuntime.jsx(LocalHeader, {});
  }
...
function CloudHeader({
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(HeaderOuter, {
    children: [/*#__PURE__*/jsxRuntime.jsx(BrandButton, {}), /*#__PURE__*/jsxRuntime.jsx(typography.Text, {
      color: "neutralEmphasis",
      weight: "semibold",
      marginX: "regular",
      truncate: true,
    ...
    }), /*#__PURE__*/jsxRuntime.jsx(Slash, {}), /*#__PURE__*/jsxRuntime.jsx(BranchPicker, {}), /*#__PURE__*/jsxRuntime.jsx(GitMenu, {}), /*#__PURE__*/jsxRuntime.jsx(layout.Box, {
      flex: "1"
    }), /*#__PURE__*/jsxRuntime.jsx(ThemeMenu, {})]
  });
}
...
function GithubHeader({
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(HeaderOuter, {
    children: [/*#__PURE__*/jsxRuntime.jsx(BrandButton, {}), /*#__PURE__*/jsxRuntime.jsx(button.Button, {
      ...
      flex: "1"
    }), /*#__PURE__*/jsxRuntime.jsx(ThemeMenu, {}), /*#__PURE__*/jsxRuntime.jsx(UserMenu, {})]
  });
}
...
function BrandButton() {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(button.Button, {
    ...
    children: /*#__PURE__*/jsxRuntime.jsx(ZapLogo, {})
  });
}
function Slash() {
...
function GitMenu() {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx(menu.ActionMenu, {
      ...
      items: gitMenuItems,
      onAction: key => {
        let repoURL = index.getRepoUrl(data);
        switch (key) {
          case 'new-branch':
...
const MainPanelLayout = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(ContentPanelProvider, {
    ...
    children: /*#__PURE__*/jsxRuntime.jsxs(splitView.SplitView, {
      ...
      maxSize: 400,
      flex: true,
      children: [isBelowDesktop ? /*#__PURE__*/jsxRuntime.jsx(SidebarDialog, {
        hrefBase: basePath,
        config: config
      }) : /*#__PURE__*/jsxRuntime.jsx(splitView.SplitPanePrimary, {
    ...
    children: /*#__PURE__*/jsxRuntime.jsx(AppStateContext.Provider, {
      ...
      children: /*#__PURE__*/jsxRuntime.jsx(SidebarProvider, {
        children: /*#__PURE__*/jsxRuntime.jsxs(layout.Flex, {
          direction: "column",
          height: "100vh",
          children: [/*#__PURE__*/jsxRuntime.jsx(TopBar, {}), /*#__PURE__*/jsxRuntime.jsx(MainPanelLayout, {
            basePath: props.basePath,
            config: props.config,
            children: content
          })]
      ...
      children: [/*#__PURE__*/jsxRuntime.jsxs(layout.Flex, {
        ...
        children: [/*#__PURE__*/jsxRuntime.jsxs(button.Button, {
          ...
          children: [/*#__PURE__*/jsxRuntime.jsx(icon.Icon, {
            ...
            src: refreshCwIcon.refreshCwIcon
          }), /*#__PURE__*/jsxRuntime.jsx(typography.Text, {
            isHidden: {
              below: 'tablet'
            },
...
function SingletonPageWrapper(props) {
  ...
  const itemData = useItemData({
    config: props.config,
    dirpath: index.getSingletonPath(props.config, props.singleton),
...
function FromTemplateDeploy(props) {
  React.useEffect(() => {
    const parsedCookies = cookie__default["default"].parse(document.cookie);
    const repo = serializeRepoConfig(props.config.storage.repo);
    const cookieName = 'ks-template';
    if (parsedCookies[cookieName] !== repo) {
      document.cookie = cookie__default["default"].serialize(cookieName, repo, {
        path: '/',
        maxAge: 60 * 60 * 24 * 30,
...
function KeystaticCloudAuthCallback({
  ...
  React.useEffect(() => {
    if (code && state && storedState.success && index.isCloudConfig(config)) {
      (async () => {
...
function PageInner({
  ...
  if (index.isGitHubConfig(config) || index.isCloudConfig(config)) {
    ...
    if (params.length === 1 && index.isGitHubConfig(config)) {
      ...
      if (params[0] === 'from-template-deploy') {
        return /*#__PURE__*/jsxRuntime.jsx(FromTemplateDeploy, {
          config: config
        });
      }
  ...
  return wrapper( /*#__PURE__*/jsxRuntime.jsx(AppShell, {
    ...
    children: /*#__PURE__*/jsxRuntime.jsx(NotFoundBoundary, {
      ...
      children: parsedParams === null ? /*#__PURE__*/jsxRuntime.jsx(AlwaysNotFound, {}) : parsedParams.collection ? parsedParams.kind === 'create' ? /*#__PURE__*/jsxRuntime.jsx(CreateItem, {
    ...
    if (props.config.storage.kind === 'github') {
      return /*#__PURE__*/jsxRuntime.jsx(layout.Flex, {
        ...
        children: /*#__PURE__*/jsxRuntime.jsx(link.LinkComponentContext.Provider, {
          value: link.DefaultLinkComponent,
          children: /*#__PURE__*/jsxRuntime.jsxs(button.Button, {
...
function Keystatic(props) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(AppSlugProvider, {
    value: props.appSlug,
